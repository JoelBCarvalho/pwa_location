  ...
  var expectedHng = document.getElementById("expected-hng");
...
*/
  ...
  function onHeadingChange(event) {
    ...
    if (typeof heading !== "undefined" && heading !== null) { // && typeof orientation !== "undefined") {
      ...
      target_rad = Math.atan2(34.325,-66);
      target_compass = (target_rad > 0 ? target_rad : (2*Math.PI+target_rad))*360 / (2*Math.PI);
      target_location = Math.round(target_compass);

      var phase = positionCurrent.hng < 0 ? 360 + positionCurrent.hng : positionCurrent.hng;
      phase_location = (360 - phase | 0);
      positionHng.textContent = phase_location + "°";
      expectedHng.textContent = target_location + "°";
      if(Math.abs(phase_location - target_location) < 20) {
        expectedHng.textContent = expectedHng.textContent + " TARGET FOUND";
      }
